...
public:		// User declarations
	...
	// Список выбранных сигнатур поиска (сюда помещаются все сигнатуры, которые были отмечены в CheckListBox)
	std::vector<UnicodeString> SelectedSignatures;  // вектор, состоящий из кол-ва выбранных сигнатур, типа UnicodeString
	// Ссылка на БД
	sqlite3* Database;
	// Ссылка на файловую систему
	class AbstractFileSystem* FileSystem;  // либо NTFS, либо exFAT
