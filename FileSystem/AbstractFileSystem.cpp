...
// Если не звершили работу, то смотрим "currentPosition + 1", выходит ли это значение за границы кластеров?
...
AbstractFileSystem* IteratorFS::GetFileSystem() {     // Текущая ФС
	return FileSystem;
}
