...
class IteratorFS {
	protected:
		...
		DWORD currentPosition;   // DWORD - 32-битное беззнаковое целое  // currentPosition - текущая позиция
		char* clusterBuffer;     // Целочисленный (символьный) тип данных    // буффер, в котором записаны данные
		bool done;               // Логический тип данных bool, правда/ложь    // флаг о завершении работы
	public:
...
class AbstractFileSystem {
	...
	public:   //   public для свободного обращения из других кодов
		...
		// IteratorFS* (указатель на объект), а не IteratorFS, чтобы не создавать копирующий конструктор AbstractFileSystem()
